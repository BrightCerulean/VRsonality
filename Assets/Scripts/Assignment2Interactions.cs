...
public class Assignment2Interactions : NetworkBehaviour
{
    ...
    private GameObject currentInventoryFull;

    [Header("Inventory Panel")]
    public GameObject inventoryPanelPrefab;
    private GameObject currentInventoryPanel;
    private int inventoryPanelIndex = 0;
    ...
    void Raycast_Handler()
    {
        ...
        if (rayLine != null)
        {
            rayLine.enabled = currentSettingsMenu == null && currentInventoryPanel == null;
    ...
    void Update()
    {
        if (OK_Pressed() && currentSettingsMenu == null && currentInventoryPanel == null && heldObject == null)
        {
            OpenSettingsMenu();
            return;
        }
